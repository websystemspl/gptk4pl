...
AS $$
DECLARE
  project_url TEXT := 'https://eevelciegqblfvfhnupr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVldmVsY2llZ3FibGZ2ZmhudXByIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzIyNDQ3NSwiZXhwIjoyMDIyODAwNDc1fQ.NMgVg-9wu6X4yQNrQbLD7rkCfP1RK17AspRhlxwZmWQ'; -- full access needed for http request to storage
